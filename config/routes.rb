Rails.application.routes.draw do
  ...
  get "/trade_proposal_status_update/:id/accepted", :controller => "users", :action => "accept_trade"

  get "/trade_proposal_status_update/:id/rejected", :controller => "users", :action => "reject_trade"
